...
\bnc that participants read at a normal reading pace, after which their memory is
...
paragraphs combined, after removing any words that occurred in the target text.
...
statistical cooccurrences of words in spoken and written language. Another
...
presumably with most words being assigned a trivial or negligible probability and
with most 
of the probability mass being assigned to a relatively small
number of words.
The participants' subsequent recall responses 
